...
for sp in range(0,4):
    ...
    ax.plot(women_degrees['Year'], women_degrees[major_cats[sp]], c=(0,107/255,164/255), label='Women')
    ax.plot(women_degrees['Year'], 100-women_degrees[major_cats[sp]], c=(1,128/255,14/255), label='Men')
