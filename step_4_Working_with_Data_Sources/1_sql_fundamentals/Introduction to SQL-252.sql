...
SELECT Major_category,Major, Unemployment_rate FROM recent_grads WHERE Major_category="Engineering" OR Major_category="Physical Sciences" ORDER BY Unemployment_rate